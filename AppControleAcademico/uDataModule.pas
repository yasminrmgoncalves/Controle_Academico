...
type
  TDataModule1 = class(TDataModule)
    ...
    sql_aluno_disciplina_: TFDQuery;
    sql_aluno_disciplina_id_aluno: TIntegerField;
    sql_aluno_disciplina_id_disciplina: TIntegerField;
    sql_aluno_disciplina_semestre: TIntegerField;
    sql_aluno_disciplina_ano: TIntegerField;
    sql_aluno_disciplina_qtd_aula: TIntegerField;
    sql_aluno_disciplina_dia_semana: TIntegerField;
    sql_aluno_disciplina_aprovado: TBooleanField;
...
begin
  ...
  if not sql_lista_espera_.Active then
    sql_lista_espera_.CreateDataset;
