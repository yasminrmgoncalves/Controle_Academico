...
begin
  ...
  DataModule1.sql_disciplinas_validas_.ParamByName('id_aluno').AsInteger := DataModule1.sql_aluno_id_aluno.AsInteger;
...
procedure TfrmPainelAluno.FormDestroy(Sender: TObject);
begin
  cbAno.Items.Clear;
...
begin
  ...
  //trazendo lista de espera
  DataModule1.sql_lista_espera_.Close;
  DataModule1.sql_lista_espera_.ParamByName('id_aluno').AsInteger := DataModule1.sql_aluno_id_aluno.AsInteger;
