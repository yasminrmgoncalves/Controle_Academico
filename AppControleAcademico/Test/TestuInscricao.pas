...
uses
  ...
  FireDAC.Comp.Client, FireDAC.Phys.MySQL, FireDAC.Phys.SQLite,
  FireDAC.Stan.Intf, FireDAC.Phys, FireDAC.Stan.ExprFuncs, FireDAC.Phys.SQLiteDef,
...
type
  ...
  strict private
    FfrmInscricao: TfrmInscricao;  // Form de inscrição
  ...
  public
    procedure SetUp; override;    // Método constructor da classe de Teste
    procedure TearDown; override;
    procedure TestCriaComponentesConexao; // Método destructor da classe de Teste
  published
    procedure TestVerificaRN01; //Método de Verificação da RN01
    procedure TestVerificaRN02; //Método de Verificação da RN02
  end;
...
var
  ...
  id_aluno: Integer;
begin
  id_aluno := 17; // aluno 'Lucia' que não tem mais limite de crédito
  ...
  CheckEquals(20, sql.Fields[0].AsInteger, 'A verificação da RN01 falhou.');
end;
...
begin
  ...
  sql.Open;
  CheckEquals(40, sql.Fields[0].AsInteger, 'A verificação da RN02 falhou.');
end;

procedure TestTfrmInscricao.TestCriaComponentesConexao;
begin
  FfrmInscricao.CriaComponentesConexao;
